...
export interface IRelayHub$Type {
  _format: 'hh-sol-artifact-1',
  contractName: 'IRelayHub',
  sourceName: '@opengsn/contracts/src/interfaces/IRelayHub.sol',
  abi: [
    {
      anonymous: false,
      inputs: [
...
declare module '@nomicfoundation/hardhat-viem/types' {
  ...
  ): Promise<GetContractReturnType<IRelayHub$Type['abi']>>
  export function deployContract (
    contractName: '@opengsn/contracts/src/interfaces/IRelayHub.sol:IRelayHub',
    constructorArgs?: [],
    config?: DeployContractConfig
  ): Promise<GetContractReturnType<IRelayHub$Type['abi']>>
  ...
  export function sendDeploymentTransaction (
    ...
    contract: GetContractReturnType<IRelayHub$Type['abi']>;
