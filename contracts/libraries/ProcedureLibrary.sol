...
library ProcedureLibrary {
    ...
    */
    ...
    // modifier onlyProposalCreator(ProcedureData storage self, uint256 proposalKey) {
    //     require(self.proposals[proposalKey].creator == msg.sender, "Not authorized.");
    //     _;
    // }
    // modifier onlyNewProposal(ProcedureData storage self, uint256 proposalKey) {
    //     require(
    //         !self.proposals[proposalKey].locked &&
    //         !self.proposals[proposalKey].applied &&
    //         !self.proposals[proposalKey].processing,
    //         "Not authorized."
    //     );
    //     _;
    // }
    // modifier onlyLockedProposal(ProcedureData storage self, uint256 proposalKey) {
    //     require(
    //         self.proposals[proposalKey].locked &&
    //         !self.proposals[proposalKey].applied &&
    //         !self.proposals[proposalKey].processing,
    ...
    */
    ...
    {
        return organ == address(0) || organ == caller || Organ(organ).getEntryIndexForAddress(caller) != 0;
    }
    ...
    */
    ...
    //     ProcedureData storage self, uint256 proposalKey,
    //     address payable organ, OrganLibrary.Entry[] memory entries,
    //     bool lock
    // )
    //     internal onlyProposalCreator(self, proposalKey) onlyNewProposal(self, proposalKey)
    // {
    ...
    //     }));
    //     if (lock) {
    //         self.proposals[proposalKey].locked = true;
    //         emit ProposalCreated(self.proposals[proposalKey].creator, proposalKey);
    //     }
    // }
    ...
    //     internal onlyProposalCreator(self, proposalKey) onlyNewProposal(self, proposalKey)
    // {
    //     Proposal storage proposal = self.proposals[proposalKey];
    ...
    //         emit ProposalCreated(proposal.creator, proposalKey);
    //     }
    // }
    ...
    // function lockProposal(ProcedureData storage self, uint256 proposalKey)
    //     internal onlyProposalCreator(self, proposalKey) onlyNewProposal(self, proposalKey)
    // {
    //     self.proposals[proposalKey].locked = true;
    //     emit ProposalCreated(msg.sender, proposalKey);
